...
Name:           mono-core
%define __majorver 5.21.0
%define __minorver 228
...
rm -f %{buildroot}%{_libdir}/libmono-system-net-security-native.a
...
%{_libdir}/libmono-system-net-security-native.so*
